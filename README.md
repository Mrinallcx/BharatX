...
![BharatX](/app/opengraph-image.png)
...
4. **Set the search engine name**:
   - Enter `BharatX` in the "Search engine" field.

5. **Set the search engine URL**:
   - Enter `https://bharat0x.xyz?q=%s` in the "URL with %s in place of query" field.

6. **Set the search engine shortcut**:
   - Enter `bx` in the "Shortcut" field.
