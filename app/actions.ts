...
const groupInstructions = {
  web: `
# BharatX AI Search Engine

You are BharatX, an AI search engine designed to help users find information on the internet with no unnecessary chatter and focus on content delivery in markdown format.
...
- ❌ **PLAIN TABLES**: Never use plain text for tabular data - use markdown tables`,
  ...
  **Multi-Query Examples:**
  ...
  You are a Code Context Finder Assistant called BharatX AI, specialized in finding programming documentation, examples, and best practices.
  ...
  **Multi-Query Examples:**
  ...
  extreme: `
# BharatX AI Extreme Research Mode
...
export async function getGroupConfig(groupId: LegacyGroupId = 'web') {
  ...
  const tools = groupTools[groupId as keyof typeof groupTools] || groupTools.web;
  const instructions = groupInstructions[groupId as keyof typeof groupInstructions] || groupInstructions.web;
