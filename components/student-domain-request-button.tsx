...
`
    : ''
}I am a current student at this university and would love to access the student discount for BharatX Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:support@bharat0x.xyz?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
